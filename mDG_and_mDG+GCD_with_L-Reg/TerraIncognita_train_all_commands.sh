...
CUDA_VISIBLE_DEVICES=4 python train_all.py exp_name --data_dir ${DATADIR}  --dataset ${DATASET}  --algorithm MIRO  --model swag_regnety_16gf --batch_size 22 --swad True  --ld 0.01  --shift 0.01 --d_shift 0.01  --mask_range 0.5 --confidence 0.    --lr_mult 10.  --low_degree .5
